...
// ─── DPDP Act 2023 – Compliant Privacy Policy (Embedded for Offline Access) ──
// Mirrors the JSON served by GET /api/v1/legal/privacy-policy.
// Kept in-memory so the app can display it without a network round-trip.
...
data class PolicySection(
    ...
    val subsections: List<PolicySubsection> = emptyList(),
    val contact: PolicyContact? = null,
)

data class PrivacyPolicy(
    val title: String,
    val platform: String,
    val dataFiduciary: String,
...
val KANOONSAATHI_PRIVACY_POLICY = PrivacyPolicy(
    ...
    sections = listOf(
            ...
            subsections = listOf(
                ...
                PolicySubsection(
                    ...
                    points = listOf(
                        ...
                        "Error and crash reports (may include partial stack traces and device state)",
                    ),
                ),
            ),
        ),
        ...
        PolicySection(
            ...
            content = listOf(
                "Some of our Data Processors, including Anthropic, OpenAI, Resend, and Upstash, are located outside India and process your personal data in jurisdictions that may not have data protection laws equivalent to Indian law.",
